          ...
          <div className="text-left space-y-4 lg:space-y-6 order-2 lg:order-1">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-4 justify-center lg:justify-start">
              <button
                ...
                className="bg-orange-500 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold text-base sm:text-lg shadow-lg hover:shadow-xl transition-all inline-flex items-center justify-center space-x-2 w-full sm:w-auto hover:bg-orange-600 transform hover:scale-105"
              >
