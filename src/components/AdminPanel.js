    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-green-100 p-4">
      ...
      <div className="bg-white border-4 border-green-500 shadow-2xl rounded-2xl p-6 mb-6 animate-slide-down">
        <div className="flex flex-col sm:flex-row justify-between items-center">
          ...
          <button
            onClick={goToHome}
            className="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-bold py-2 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg animate-slide-in-right"
          >
            Volver al Inicio
          </button>
        </div>
